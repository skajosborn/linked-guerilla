...
export default function MessagingInterface() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl overflow-hidden border border-gray-200" style={{ maxWidth: '900px', height: '600px' }}>
      {/* Header */}
      ...
      <div className="flex h-full" style={{ height: 'calc(600px - 73px)' }}>
