...
export default function MessagingInterface() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl overflow-hidden border border-gray-200" style={{ maxWidth: '900px', height: '550px' }}>
      {/* Header */}
      ...
      <div className="flex h-full" style={{ height: 'calc(550px - 73px)' }}>
